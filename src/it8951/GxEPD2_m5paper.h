...
class GxEPD2_m5paper : public GxEPD2_EPD
{
  public:
    ...
    static const uint16_t HEIGHT = 540;
    ...
    static const uint16_t power_on_time = 5000; // ms, e.g. 3879us
    static const uint16_t power_off_time = 200; // ms, e.g. 109875us
    static const uint16_t full_refresh_time = 224001; // ms, e.g. 573921us
    static const uint16_t partial_refresh_time = 300; // ms, e.g. 246948us
    static const uint16_t refresh_cmd_time = 5930; // ms, e.g. 6460us
    static const uint16_t refresh_par_time = 2; // ms, e.g. 1921us
    static const uint16_t default_wait_time = 5000; // ms, default busy check, needed?
    static const uint16_t diag_min_time = 3; // ms, e.g. > refresh_par_time
    static const uint16_t set_vcom_time = 5000; // ms, e.g. 37833us
    // constructor
    GxEPD2_m5paper(int16_t cs, int16_t dc, int16_t rst, int16_t busy); // TODO: Remove unnecessary pin definitions - the M5Paper has fixed pins
    // methods (virtual)
