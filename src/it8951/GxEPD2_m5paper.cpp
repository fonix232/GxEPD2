...
#include "GxEPD2_m5paper.h"

#define VCOM  2300 //e.g. -1.53 = 1530 = 0x5FA
...
GxEPD2_m5paper::GxEPD2_m5paper(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
...
void GxEPD2_m5paper::init(uint32_t serial_diag_bitrate)
{
  init(serial_diag_bitrate, true, 20, false);
}

void GxEPD2_m5paper::init(uint32_t serial_diag_bitrate, bool initial, uint16_t reset_duration, bool pulldown_rst_mode)
{
...
void GxEPD2_m5paper::clearScreen(uint8_t value)
{
...
void GxEPD2_m5paper::writeScreenBuffer(uint8_t value)
{
  if (_initial_refresh) clearScreen(value);
  else _writeScreenBuffer(value);
}

void GxEPD2_m5paper::_writeScreenBuffer(uint8_t value)
{
  _initial_write = false; // initial full screen buffer clean done
...
void GxEPD2_m5paper::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_m5paper::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_m5paper::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black)
  {
...
void GxEPD2_m5paper::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                 int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black)
  {
...
void GxEPD2_m5paper::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (data1)
  {
    if (_initial_write) writeScreenBuffer(); // initial full screen buffer clean
...
void GxEPD2_m5paper::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  _refresh(x, y, w, h, true);
}

void GxEPD2_m5paper::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_m5paper::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  _refresh(x, y, w, h, true);
}

void GxEPD2_m5paper::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_m5paper::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  _refresh(x, y, w, h, false);
}

void GxEPD2_m5paper::refresh(bool partial_update_mode)
{
  _refresh(0, 0, WIDTH, HEIGHT, partial_update_mode);
}

void GxEPD2_m5paper::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  _refresh(x, y, w, h, true);
}

void GxEPD2_m5paper::_refresh(int16_t x, int16_t y, int16_t w, int16_t h, bool partial_update_mode)
{
  //x -= x % 8; // byte boundary
  //w -= x % 8; // byte boundary
  int16_t x1 = x < 0 ? 0 : x; // limit
...
void GxEPD2_m5paper::powerOff(void)
{
  _PowerOff();
}

void GxEPD2_m5paper::hibernate()
{
...
void GxEPD2_m5paper::_send8pixel(uint8_t data)
{
...
void GxEPD2_m5paper::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_m5paper::_InitDisplay()
{
  // we need a long reset pulse
...
void GxEPD2_m5paper::_Init_Full()
{
  _InitDisplay();
  _PowerOn();
  _using_partial_mode = false;
...
void GxEPD2_m5paper::_Init_Part()
{
  _InitDisplay();
  _PowerOn();
...
void GxEPD2_m5paper::_waitWhileBusy2(const char* comment, uint16_t busy_time)
{
  if (_busy >= 0)
  {
...
uint16_t GxEPD2_m5paper::_transfer16(uint16_t value)
{
  uint16_t rv = SPI.transfer(value >> 8) << 8;
  return (rv | SPI.transfer(value));
}

void GxEPD2_m5paper::_writeCommand16(uint16_t c)
{
...
void GxEPD2_m5paper::_writeData16(uint16_t d)
{
...
void GxEPD2_m5paper::_writeData16(const uint16_t* d, uint32_t n)
{
  _waitWhileBusy2("_writeData16", default_wait_time);
  SPI.beginTransaction(_spi_settings);
  if (_cs >= 0) digitalWrite(_cs, LOW);
...
uint16_t GxEPD2_m5paper::_readData16()
{
...
void GxEPD2_m5paper::_readData16(uint16_t* d, uint32_t n)
{
  _waitWhileBusy2("_readData16", default_wait_time);
  SPI.beginTransaction(_spi_settings);
  if (_cs >= 0) digitalWrite(_cs, LOW);
...
void GxEPD2_m5paper::_writeCommandData16(uint16_t c, const uint16_t* d, uint16_t n)
{
  _writeCommand16(c);
...
void GxEPD2_m5paper::_IT8951SystemRun()
{
  _writeCommand16(IT8951_TCON_SYS_RUN);
}

void GxEPD2_m5paper::_IT8951StandBy()
{
  _writeCommand16(IT8951_TCON_STANDBY);
}

void GxEPD2_m5paper::_IT8951Sleep()
{
  _writeCommand16(IT8951_TCON_SLEEP);
}

uint16_t GxEPD2_m5paper::_IT8951ReadReg(uint16_t usRegAddr)
{
  uint16_t usData;
...
void GxEPD2_m5paper::_IT8951WriteReg(uint16_t usRegAddr, uint16_t usValue)
{
...
uint16_t GxEPD2_m5paper::_IT8951GetVCOM(void)
{
  uint16_t vcom;
...
void GxEPD2_m5paper::_IT8951SetVCOM(uint16_t vcom)
{
  _writeCommand16(USDEF_I80_CMD_VCOM);
