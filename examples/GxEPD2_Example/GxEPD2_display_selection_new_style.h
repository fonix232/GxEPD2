...
//#define GxEPD2_DRIVER_CLASS GxEPD2_m5paper       // M5Paper 960x540
...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 15, /*DC=*/ 0, /*RST=*/ 0, /*BUSY=*/ 27)); // M5Paper
#else
